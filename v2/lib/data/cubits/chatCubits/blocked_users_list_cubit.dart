...
class BlockedUsersListCubit extends Cubit<BlockedUsersListState> with HydratedMixin {
  ...
  void blockedUsersList() async {
    try {
      ...
      DataOutput<BlockedUserModel> result = await _chatRepository.blockedUsersListApi();
