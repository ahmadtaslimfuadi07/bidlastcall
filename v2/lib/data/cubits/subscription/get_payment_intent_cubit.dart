...
class GetPaymentIntentCubit extends Cubit<GetPaymentIntentState> {
  ...
  void getPaymentIntent({required int packageId, required String paymentMethod}) async {
    emit(GetPaymentIntentInProgress());

    repository.getPaymentIntent(packageId: packageId, paymentMethod: paymentMethod).then((value) {
