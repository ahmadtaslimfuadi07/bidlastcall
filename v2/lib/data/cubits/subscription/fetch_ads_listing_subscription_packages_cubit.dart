...
class FetchAdsListingSubscriptionPackagesInProgress extends FetchAdsListingSubscriptionPackagesState {}
...
class FetchAdsListingSubscriptionPackagesCubit extends Cubit<FetchAdsListingSubscriptionPackagesState> {
  ...
  Future<void> fetchPackages() async {
    try {
      ...
      DataOutput<SubscriptionPackageModel> result = await _subscriptionRepository.getSubscriptionPacakges(type: "item_listing");
      emit(FetchAdsListingSubscriptionPackagesSuccess(subscriptionPackages: result.modelList));
    } catch (e) {
