...
class FetchHomeScreenCubit extends Cubit<FetchHomeScreenState> with HydratedMixin {
  ...
  fetch({String? city, int? areaId}) async {
    try {
      ...
      List<HomeScreenSection> homeScreenDataList = await _homeRepository.fetchHome(city: city, areaId: areaId);
