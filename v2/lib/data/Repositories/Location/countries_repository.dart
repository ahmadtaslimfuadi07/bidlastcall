...
class CountriesRepository {
  Future<DataOutput<CountriesModel>> fetchCountries({required int page, String? search}) async {
    Map<String, dynamic> parameters = {Api.page: page, if (search != null) Api.search: search};
    ...
    List<CountriesModel> modelList = (response['data']['data'] as List).map((e) => CountriesModel.fromJson(e)).toList();
