...
class HomeScreenSection {
  ...
  HomeScreenSection({this.sectionId, this.style, this.title, this.totalData, this.sectionData});
...
class UserDetails {
  ...
  UserDetails({this.id, this.name, this.mobile, this.email, this.type, this.profile, this.fcmId, this.firebaseId, this.status, this.apiToken, this.address, this.createdAt, this.updatedAt});
