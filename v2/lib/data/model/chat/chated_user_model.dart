...
class ChatedUser {
  ...
  ChatedUser({this.id, this.sellerId, this.buyerId, this.itemId, this.createdAt, this.updatedAt, this.amount, this.seller, this.buyer, this.userBlocked, this.item});
...
class Item {
  ...
  Item({this.id, this.name, this.description, this.price, this.image, this.status});
