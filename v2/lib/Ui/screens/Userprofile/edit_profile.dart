...
class UserProfileScreenState extends State<UserProfileScreen> {
  ...
  final TextEditingController sellerUnameController = TextEditingController();
  final TextEditingController buyerUnameController = TextEditingController();
  ...
  void initState() {
    ...
    if (HiveUtils.getCountryCode() != null) {
      ...
      phoneController.text = HiveUtils.getUserDetails().mobile != null ? HiveUtils.getUserDetails().mobile!.replaceFirst("+$countryCode", "") : "";
    } else {
                    ...
                    child: Padding(
                      ...
                      child: Form(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                            ...
                            buildTextField(
                              context,
                              title: "usernameSeller",
                              controller: sellerUnameController,
                              validator: CustomTextFieldValidator.nullCheck,
                            ),
                            buildTextField(
                              context,
                            ...
                            UiUtils.buildButton(
                              ...
                              onPressed: () {
                                if (widget.from == 'login') {
                                  ...
                                  if (city != null && city != "") {
                                    HiveUtils.setCurrentLocation(city: city, state: _state, country: country, latitude: latitude, longitude: longitude);
  ...
  Widget phoneWidget() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text("phoneNumber".translate(context)).color(context.color.textDefaultColor),
      SizedBox(
        height: 10.rh(context),
      ),
      CustomTextFormField(
      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: Text((isNotificationsEnabled ? "enabled".translate(context) : "disabled".translate(context)).translate(context)).size(context.font.large),
          ),
          CupertinoSwitch(
  ...
  Widget buildTextField(BuildContext context, {required String title, required TextEditingController controller, CustomTextFieldValidator? validator, bool? readOnly}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(
  ...
  Widget buildAddressTextField(BuildContext context, {required String title, required TextEditingController controller, CustomTextFieldValidator? validator, bool? readOnly}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(
        ...
        PositionedDirectional(
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                width: 37.rw(context),
                alignment: AlignmentDirectional.center,
                decoration: BoxDecoration(border: Border.all(color: context.color.buttonColor, width: 1.5), shape: BoxShape.circle, color: context.color.territoryColor),
                child: SizedBox(width: 15.rw(context), height: 15.rh(context), child: UiUtils.getSvg(AppIcons.edit))),
          ),
        )
      ],
    );
