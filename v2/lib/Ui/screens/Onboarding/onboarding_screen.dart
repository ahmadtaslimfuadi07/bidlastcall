            ...
            children: [
              Stack(
                children: <Widget>[
                  ...
                  //         },
                  //         child: StreamBuilder(
                  //             stream: Hive.box(HiveKeys.languageBox).watch(key: HiveKeys.currentLanguageKey),
                  //             builder: (context, AsyncSnapshot<BoxEvent> value) {
                  //               final defaultLanguage = context.watch<FetchSystemSettingsCubit>().getSetting(SystemSetting.defaultLanguage).toString().firstUpperCase();

                  //               final languageCode = value.data?.value?['code'] ?? defaultLanguage ?? "En";
                      ...
                      child: GestureDetector(
                        ...
                        onHorizontalDragEnd: (DragEndDetails details) {
                          if (currentSwipe < 0.9) {
                            ...
                            if (currentPageIndex < totalPages) {
                              if (changedOnPageScroll == 0 || changedOnPageScroll == 0.5) {
                                if (currentPageIndex < slidersList.length - 1) {
                                  currentPageIndex++;
                                } else {
                                  // Navigator.of(context).pushNamedAndRemoveUntil(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                SizedBox(
                                  ...
                                  child: SvgPicture.asset(slidersList[currentPageIndex]['svg']),
                                ),
                                SizedBox(
                                ...
                                SizedBox(
                                  width: context.screenWidth,
                                  child: Text(slidersList[currentPageIndex]['title']).size(context.font.extraLarge).bold(weight: FontWeight.w600).color(context.color.textDefaultColor).centerAlign(),
                                ),
                                SizedBox(
                                ...
                                SizedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(slidersList[currentPageIndex]['description']).centerAlign().size(context.font.larger),
                                  ),
                                ),
                                SizedBox(
                  ...
                  /* Positioned.directional(
                    ...
                    child: GestureDetector(
                      onHorizontalDragUpdate: (DragUpdateDetails details) {
                        currentSwipe = details.primaryDelta?. ?? 0.0;
                      },
                      onHorizontalDragEnd: (DragEndDetails details) {
                        if (currentSwipe > 0) {
                          if (currentPageIndex < slidersList.length - 1) {
                  ...
                  Positioned.directional(
                      textDirection: Directionality.of(context),
                      top: context.screenHeight * ((0.636 * heightFactor) / 0.7),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              boxShadow: context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark
                                  ? null
                                  : [BoxShadow(color: context.color.forthColor.withOpacity(0.8), blurRadius: 10, offset: const Offset(0, 4), spreadRadius: 1)],
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark
                      ? null
                      : [BoxShadow(color: context.color.territoryColor.withOpacity(0.8), blurRadius: 10, offset: const Offset(0, 4), spreadRadius: 1)],
                ),
                child: MaterialButton(
                  onPressed: () {
                    HiveUtils.setUserIsNotNew();
                  ...
                  child: Text(currentPageIndex < slidersList.length - 1 ? "signIn".translate(context) : "getStarted".translate(context)).color(context.color.buttonColor).size(context.font.larger),
                ),
              ),
            ],
          )),
...
class IndicatorBuilder extends StatelessWidget {
  ...
  const IndicatorBuilder({super.key, required this.total, required this.selectedIndex});
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              height: 10,
              decoration: BoxDecoration(color: context.color.territoryColor, borderRadius: BorderRadius.circular(6)),
            );
          },
