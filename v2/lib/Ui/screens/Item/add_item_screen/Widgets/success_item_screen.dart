...
class SuccessItemScreen extends StatefulWidget {
  ...
  const SuccessItemScreen({super.key, required this.model, required this.isEdit});
...
class _SuccessItemScreenState extends State<SuccessItemScreen> with SingleTickerProviderStateMixin {
                        ...
                        SlideTransition(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 18),
                              Text(widget.isEdit ? 'updatedSuccess'.translate(context) : 'submittedSuccess'.translate(context))
                                  .centerAlign()
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Text("previewAd".translate(context)).centerAlign().size(context.font.larger).color(context.color.territoryColor),
                                ),
                              ),
                              SizedBox(height: 15),
                              InkWell(
                                ...
                                child: Text('backToHome'.translate(context)).underline().centerAlign().size(context.font.larger).color(context.color.textDefaultColor),
                              ),
                            ],
                          ),
                        ),
