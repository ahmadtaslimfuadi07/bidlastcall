          ...
          children: [
            Container(
              ...
              child: SizedBox(
                ...
                child: FittedBox(
                  fit: BoxFit.none,
                  child: UiUtils.imageType(parameters['image'], width: 20, height: 20, fit: BoxFit.cover, color: context.color.textDefaultColor),
                ),
              ),
            ),
            SizedBox(
            ...
            child: Padding(
              ...
              child: SizedBox(
                ...
                child: DropdownButton(
                  ...
                  items: (parameters['values'] as List<dynamic>).map<DropdownMenuItem<dynamic>>((dynamic e) {
