              ...
              children: [
                Container(
                  ...
                  child: SizedBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.none,
                      child: UiUtils.imageType(parameters['image'], width: 24, height: 24, fit: BoxFit.cover, color: context.color.textDefaultColor),
                    ),
                  ),
                ),
                SizedBox(
                ...
                Text(parameters['name']).size(context.font.large).bold(weight: FontWeight.w500).color(state.hasError ? context.color.error : context.color.textColorDark)
              ],
            ),
            SizedBox(
              ...
              children: [
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                color: selectedRadioValue == element ? context.color.territoryColor.withOpacity(0.1) : context.color.secondaryColor,
                                borderRadius: BorderRadius.circular(10)),
                            child: Padding(
                                padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 15),
                                child: Text(values![index]).color((selectedRadioValue == element ? context.color.territoryColor : context.color.textLightColor))),
                          ),
                        ),
                      );
                    })),
                if (state.hasError)
                  Padding(
                    ...
                    child: Text(state.errorText ?? "").size(context.font.small).color(context.color.error),
                  )
              ],
            )
          ],
