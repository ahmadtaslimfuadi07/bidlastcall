                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              color: isChecked ? context.color.territoryColor.withOpacity(0.1) : context.color.secondaryColor,
                              borderRadius: BorderRadius.circular(10),
                            ),
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    color: isChecked ? context.color.territoryColor : context.color.textColorDark,
                                  ),
                                  const SizedBox(
                                    width: 5,
                                  ),
                                  Text(value).color(isChecked ? context.color.territoryColor : context.color.textLightColor),
                                ],
                              ),
                            ),
                          ),
