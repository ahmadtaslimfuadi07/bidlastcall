...
class SectionItemsScreen extends StatefulWidget {
  ...
  static Route route(RouteSettings routeSettings) {
    ...
    return BlurredRouter(
      builder: (_) => SectionItemsScreen(title: arguments['title'], sectionId: arguments['sectionId']),
    );
  }
      ...
      () {
        if (_controller.offset >= _controller.position.maxScrollExtent) {
          if (context.read<FetchSectionItemsCubit>().hasMoreData()) {
            setState(() {});
            context.read<FetchSectionItemsCubit>().fetchSectionItemMore(widget.sectionId);
          }
        }
      },
    );
