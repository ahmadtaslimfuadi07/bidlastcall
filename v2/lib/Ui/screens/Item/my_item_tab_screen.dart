...
class _MyItemTabState extends CloudState<MyItemTab> {
  ...
  void setReferenceOfCubit() {
    myAdsCubitReference[widget.getItemsWithStatus!] = context.read<FetchMyItemsCubit>();
  }
                      ...
                      return InkWell(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                                color: item.status == "inactive" ? context.color.deactivateColor.brighten(70) : context.color.secondaryColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [Text("${Constant.currencySymbol}\t${item.price}").color(context.color.territoryColor).bold(), Spacer(), showStatus(item)],
                                        ),
                                        //SizedBox(height: 7,),
                                        Text(item.name ?? "").setMaxLines(lines: 2).firstUpperCaseWidget(),
                                        //SizedBox(height: 12,),
                                        Row(
                                          //mainAxisAlignment: MainAxisAlignment.spaceAround,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          children: [
                                            Flexible(
                                              ...
                                              child: Row(
                                                mainAxisSize: MainAxisSize.min,
                                                children: [
                                                  SvgPicture.asset(AppIcons.eye, width: 14, height: 14, colorFilter: ColorFilter.mode(context.color.textDefaultColor, BlendMode.srcIn)),
                                                  const SizedBox(
                                                    width: 4,
                                                  ),
                                                  Text("${"views".translate(context)}:${item.views}").size(context.font.small).color(context.color.textColorDark.withOpacity(0.5)),
                                                ],
                                              ),
                                            ),
                                            SizedBox(
                                            ...
                                            Flexible(
                                              ...
                                              child: Row(
                                                mainAxisSize: MainAxisSize.min,
                                                children: [
                                                  SvgPicture.asset(AppIcons.heart, width: 14, height: 14, colorFilter: ColorFilter.mode(context.color.textDefaultColor, BlendMode.srcIn)),
                                                  const SizedBox(
                                                    width: 4,
                                                  ),
                                                  Text("${"like".translate(context)}:${item.totalLikes.toString()}").size(context.font.small).color(context.color.textColorDark.withOpacity(0.5)),
                                                ],
                                              ),
                                            ),
                                          ],
