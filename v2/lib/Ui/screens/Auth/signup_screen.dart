  ...
  void onTapSignup() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      context
          ...
          .setData(payload: EmailLoginPayload(email: _emailController.text, password: _passwordController.text, type: EmailLoginType.signup), type: AuthenticationType.email);
          ...
          listener: (context, state) {
            ...
            if (state is AuthenticationFail) {
              if (state.error is FirebaseAuthException) {
                HelperUtils.showSnackBarMessage(context, (state.error as FirebaseAuthException).message!);
              }
            }
          },
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("welcome".translate(context)).size(context.font.extraLarge),
                      const SizedBox(
                        height: 8,
                      ),
                      Text("signUpToeClassify".translate(context)).size(context.font.large).color(
                      ...
                      Row(
                        ...
                        children: [
                          Text("alreadyHaveAcc".translate(context)).color(context.color.textColorDark.brighten(50)),
                          const SizedBox(
                            width: 12,
                          ),
                          GestureDetector(
                            ...
                            child: Text("login".translate(context)).underline().color(context.color.territoryColor),
                          )
                        ],
                      ),
                      const SizedBox(
                      ...
                      Center(
                        child: Text("orSignInWith".translate(context)).color(context.color.textDefaultColor).centerAlign(),
                      ),
                      const SizedBox(
                        height: 24,
                      ),
