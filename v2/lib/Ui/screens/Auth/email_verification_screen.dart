...
class EmailVerificationScreen extends StatefulWidget {
  ...
  EmailVerificationScreen({super.key, required this.email, required this.password, required this.username});
...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("youHaveGotEmail".translate(context)).size(context.font.extraLarge).bold(weight: FontWeight.w600),
                      const SizedBox(
                        height: 14,
                      ),
                      ...
                      MaterialButton(
                        ...
                        color: isVerified ? context.color.territoryColor : context.color.textLightColor,
                        child: Text(isVerified ? "verified".translate(context) : "checkMail".translate(context)).color(context.color.buttonColor).size(context.font.large),
                      ),
                    ],
                  ),
                ),
  ...
  void openEmailAppToList() async {
    ...
    if (await canLaunchUrlString(customUriScheme)) {
      ...
      await launchUrlString('mailto:'); // Opens the email app without specifying the inbox
    }
  }
}
