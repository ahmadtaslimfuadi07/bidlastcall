...
class ReadMoreText extends StatefulWidget {
  ...
  const ReadMoreText({super.key, required this.text, this.maxVisibleCharectors, this.style, this.readMoreButtonStyle});
...
class _ReadMoreTextState extends State<ReadMoreText> {
      ...
      return Wrap(
        children: [
          ...
          TextButton(
            ...
            child: Text(
              showingFullText ? "readLessLbl".translate(context) : "readMoreLbl".translate(context),
  ...
  String _truncateText(String text) {
    ...
    final endIndex = textPainter.getPositionForOffset(Offset(MediaQuery.of(context).size.width, double.infinity)).offset;
