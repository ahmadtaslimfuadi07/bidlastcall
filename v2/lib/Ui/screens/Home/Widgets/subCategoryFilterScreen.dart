...
class SubCategoryFilterScreen extends StatefulWidget {
  ...
  const SubCategoryFilterScreen({super.key, required this.addModel, required this.model});
...
class _SubCategoryFilterScreenState extends State<SubCategoryFilterScreen> with TickerProviderStateMixin {
  @override
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            leading: Container(
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: context.color.territoryColor.withOpacity(0.1)),
