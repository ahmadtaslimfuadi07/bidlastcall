    ...
    if (type == ListUiType.List) {
      return SizedBox(
        ...
        child: ListView.separated(
          padding: EdgeInsets.symmetric(horizontal: isNotSidePadding != null ? 0 : sidePadding),
      ...
      return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCountAndFixedHeight(crossAxisCount: crossAxisCount ?? 2, height: height ?? 1, mainAxisSpacing: 15, crossAxisSpacing: 15),
        itemBuilder: (context, index) => builder(context, index, false),
        itemCount: total,
      );
        ...
        if (listItemCount > 0) {
          children.add(
            ListView.builder(
              ...
              physics: const NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) => builder(context, i + gridCount + index, false),
