...
class ItemHorizontalCard extends StatelessWidget {
  ...
  const ItemHorizontalCard(
      {super.key, required this.item, this.useRow, this.addBottom, this.additionalHeight, this.statusButton, this.showDeleteButton, this.onDeleteTap, this.showLikeButton, this.additionalImageWidth});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(border: Border.all(color: context.color.borderColor.darken(50)), color: context.color.secondaryColor, borderRadius: BorderRadius.circular(15)),
        child: Stack(
          fit: StackFit.expand,
          children: [
            Column(
                        ...
                        children: [
                          Stack(
                            children: [
                              ...
                              if (item.isFeature ?? false) const PositionedDirectional(start: 5, top: 5, child: PromotedCard(type: PromoteCardType.icon)),
                            ],
                          ),
                          if (statusButton != null)
                            Padding(
                              ...
                              child: Container(
                                ...
                                width: 80,
                                height: 120 - 90 - 8,
                                child: Center(child: Text(statusButton!.lable).size(context.font.small).bold().color(statusButton?.textColor ?? Colors.black)),
                              ),
                            )
                        ],
                      ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ).setMaxLines(lines: 2).size(context.font.normal).color(context.color.textDefaultColor),
                              //SizedBox(height: 5),
                              if (item.address != "")
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(item.address?.trim() ?? "").setMaxLines(lines: 1).color(context.color.textDefaultColor.withOpacity(0.5)).size(context.font.smaller),
                                    )
                                  ],
                                )
                            ],
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark
                          ? null
                          : [BoxShadow(color: Color.fromARGB(33, 0, 0, 0), offset: Offset(0, 2), blurRadius: 15, spreadRadius: 0)],
                    ),
                    child: SizedBox(
                      height: 24,
                      width: 24,
