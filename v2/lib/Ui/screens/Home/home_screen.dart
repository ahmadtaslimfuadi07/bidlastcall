    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: Padding(padding: EdgeInsetsDirectional.only(start: sidePadding.rw(context), end: sidePadding.rw(context)), child: const LocationWidget()),
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding: EdgeInsets.symmetric(horizontal: index == 0 ? 0 : 10.0),
                    child: const Column(
...
Widget _builderWrapper(FetchHomeAllItemsSuccess state, BuildContext context, int index, bool isGrid) {
  ItemModel? item = state.items[index];
