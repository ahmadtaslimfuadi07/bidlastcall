                      ...
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(width: context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark ? 0 : 1, color: context.color.borderColor.darken(30)),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context, Routes.filterScreen, arguments: {"update": getFilterValue, "from": "search"}).then((value) {
                              if (value == true) {
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: UiUtils.getSvg(AppIcons.filter, color: context.color.territoryColor),
                            ),
                          ),
                        ),
                      ],
  ...
  Widget bodyData() {
    return BlocConsumer<SearchItemCubit, SearchItemState>(
      ...
      builder: (context, searchState) {
        print("search state****$searchState*****${searchState is SearchItemSuccess && searchState.searchedItems.isNotEmpty}");
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              buildHistoryItemList(),
              if (searchController.text.isNotEmpty || hasSearchResults) searchItemsWidget() else popularItemsWidget(),
            ],
          ),
        );
      },
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("recentSearches".translate(context)).color(context.color.textDefaultColor.withOpacity(0.5)),
                    InkWell(
                      child: Text("clear".translate(context)).color(context.color.territoryColor),
                      onTap: () {
                        clearBoxData();
                      },
                    ),
                        ...
                        Expanded(
                          child: RichText(
                            text: TextSpan(
                              ...
                              style: TextStyle(color: context.color.textDefaultColor.withOpacity(0.5), overflow: TextOverflow.ellipsis),
                              children: <TextSpan>[
                                TextSpan(
          ...
          if (state.errorMessage is ApiException) {
            if (state.errorMessage == "no-internet") {
              return SingleChildScrollView(
                child: NoInternet(
                  onRetry: () {
                    context.read<SearchItemCubit>().searchItem(searchController.text.toString(), page: 1);
                  },
                ),
              );
            }
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("searchedItems".translate(context)).color(context.color.textDefaultColor.withOpacity(0.5)).size(context.font.normal),
                ),
                SizedBox(
                  height: 3,
                ),
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.only(start: 5.0),
                  child: Text("popularAds".translate(context)).color(context.color.textDefaultColor.withOpacity(0.5)).size(context.font.normal),
                ),
                SizedBox(
                  height: 3,
                ),
