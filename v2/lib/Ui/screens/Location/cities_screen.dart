                            ...
                            return BlocListener<FetchAreasCubit, FetchAreasState>(
                              listener: (context, area) {
                                ...
                                if (area is FetchAreasSuccess) {
                                  print("area.areasModel.isNotEmpty${area.areasModel.isNotEmpty}");
                                  if (area.areasModel.isNotEmpty) {
                                    ...
                                    if (widget.from == "home") {
                                      HiveUtils.setLocation(
                                          city: city.name!, state: widget.stateName, country: widget.countryName, latitude: double.parse(city.latitude!), longitude: double.parse(city.longitude!));
