...
//This will create delay so we don't face rapid api call
  ...
  defaultLocation() {
    _currentLocation = [HiveUtils.getCurrentAreaName(), HiveUtils.getCurrentCityName(), HiveUtils.getCurrentStateName(), HiveUtils.getCurrentCountryName()]
        .where((part) => part != null && part.isNotEmpty)
        .join(', ');
    _locationStatus = _currentLocation.isNotEmpty ? 'locationFetched' : 'enableLocation';
    setState(() {});
  }
        ...
        if (mounted) {
          ...
          if (widget.from == "home") {
            ...
            Future.delayed(Duration.zero, () {
              ...
              context.read<FetchHomeAllItemsCubit>().fetch(city: placemark.locality!);
            });
            Navigator.pop(context);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("useCurrentLocation".translate(context)).color(context.color.territoryColor).bold(weight: FontWeight.bold),
                          Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        ).color(context.color.textDefaultColor).size(context.font.normal).bold(weight: FontWeight.w600),
                      ),
                      const Divider(
                        thickness: 1.2,
                        height: 10,
                      ...
                      Flexible(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              onTap: () {
                                Navigator.pushNamed(context, Routes.statesScreen, arguments: {"countryId": country.id!, "countryName": country.name!, "from": widget.from});
                              },
                              title: Text(
                                country.name!,
                                ...
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
                              ).color(context.color.textDefaultColor).size(context.font.normal),
                              trailing: Container(
                                  width: 32,
                                  height: 32,
