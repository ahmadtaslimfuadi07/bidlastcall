...
import '../../../data/cubits/item/fetch_my_promoted_items_cubit.dart';
...
class _MyAdvertisementScreenState extends State<MyAdvertisementScreen> {
  ...
  void initState() {
    ...
    Future.delayed(
      Duration.zero,
      () {
        statusMap = {0: "approved".translate(context), 1: "pending".translate(context), 2: "rejected".translate(context)};
      },
    );
