...
/*  Future<void> locationPermission() async {
  ...
  void navigateCheck() {
    print("${isTimerCompleted}  -- $isSettingsLoaded -- $isLanguageLoaded");
  ...
  void navigateToScreen() async {
    ...
    if (context.read<FetchSystemSettingsCubit>().getSetting(SystemSetting.maintenanceMode) == "1") {
      ...
      if ((HiveUtils.getUserDetails().name == null || HiveUtils.getUserDetails().name == "") ||
          (HiveUtils.getUserDetails().email == null || HiveUtils.getUserDetails().email == "") ||
          (HiveUtils.getUserDetails().mobile == null || HiveUtils.getUserDetails().mobile == "")) {
        Future.delayed(
                  ...
                  body: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Text("Bidlastcall".translate(context)).size(context.font.xxLarge).color(context.color.secondaryColor).centerAlign().bold(weight: FontWeight.w600),
                            Text("\"${"buyAndSellAnything".translate(context)}\"").size(context.font.smaller).color(context.color.secondaryColor).centerAlign(),
                          ],
                        ),
                      ),
                    ],
