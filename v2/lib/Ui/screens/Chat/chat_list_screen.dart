          ...
          appBar: UiUtils.buildAppBar(
            ...
            bottom: [
              TabBar(
                ...
                unselectedLabelColor: context.color.textDefaultColor.withOpacity(0.5),
              ...
              Divider(
                ...
                color: context.color.textDefaultColor.withOpacity(0.2), // Divider color
              ),
            ],
          ),
          body: TabBarView(
                      ...
                      itemBuilder: (
                        ...
                        return Padding(
                          ...
                          child: ChatTile(
                            ...
                            itemPicture: chatedUser.item != null && chatedUser.item!.image != null ? chatedUser.item!.image! : "",
                            itemName: chatedUser.item != null && chatedUser.item!.name != null ? chatedUser.item!.name! : "",
                            ...
                            status: chatedUser.item != null && chatedUser.item!.status != null ? chatedUser.item!.status! : null,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: Colors.grey, border: Border.all(width: 1.5, color: Colors.white), borderRadius: BorderRadius.circular(10)),
                            ),
                          ),
