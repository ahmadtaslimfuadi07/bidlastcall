...
class ChatMessage extends StatefulWidget {
  ...
  const ChatMessage(
      {super.key, this.id, required this.senderId, required this.itemOfferId, this.message, this.file, this.audio, required this.createdAt, required this.updatedAt, this.messageType, this.isSentNow});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Container(
          alignment: widget.senderId.toString() == HiveUtils.getUserId() ? AlignmentDirectional.centerEnd : AlignmentDirectional.centerStart,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color: selectedMessage == true
                        ? (widget.senderId.toString() == HiveUtils.getUserId() ? context.color.territoryColor.darken(45) : context.color.secondaryColor.darken(45))
                        : (widget.senderId.toString() == HiveUtils.getUserId() ? context.color.territoryColor.withOpacity(0.3) : context.color.secondaryColor),
                ...
                child: Wrap(
                  ...
                  children: [
                        ...
                        child: widget.audio != ""
                            ...
                            : Column(
                                ...
                                children: [
                                  ...
                                  SelectableText.rich(
                                    TextSpan(
                                      style: TextStyle(color: (isDark && widget.senderId.toString() != HiveUtils.getUserId()) ? context.color.buttonColor : context.color.textDefaultColor),
                                      children: _replaceLink().map((data) {
                                        ...
                                        return TextSpan(
                                          ...
                                          children: _matchAstric(data).map((text) {
                                            if (text.toString().startsWith("*") && text.toString().endsWith("*")) {
                                              return TextSpan(
                                                  ...
                                                  style: TextStyle(
                                                      color: (isDark && widget.senderId.toString() != HiveUtils.getUserId()) ? context.color.buttonColor : context.color.textDefaultColor,
                                          ...
                                          style: TextStyle(color: widget.senderId.toString() == HiveUtils.getUserId() ? context.color.secondaryColor : context.color.textColorDark),
                                        );
                                      }).toList(),
                                    ),
                                    style: TextStyle(color: (isDark && widget.senderId.toString() != HiveUtils.getUserId()) ? context.color.buttonColor : context.color.textDefaultColor),
                    ...
                    if (widget.senderId.toString() != HiveUtils.getUserId() && (widget.isSentNow != null ? widget.isSentNow! : widget.createdAt == DateTime.now().toString())) ...[
              ...
              Padding(
                ...
                child: Text(
                  (DateTime.parse(widget.createdAt)).toLocal().toIso8601String().toString().formatDate(format: "hh:mm aa"), //
                  style: TextStyle(color: widget.senderId.toString() != HiveUtils.getUserId() ? context.color.textLightColor : context.color.textLightColor),
                ).size(context.font.smaller),
              ),
            ],
          ),
