import 'package:eClassify/Ui/screens/widgets/AnimatedRoutes/blur_page_route.dart' show BlurredRouter;
            ...
            if (state is FetchBlogsSuccess) {
              ...
              return Column(
                ...
                children: <Widget>[
                  ...
                  if (state.loadingMoreError) Text("somethingWentWrng".translate(context))
                ],
              );
            }
            return Container();
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(stripHtmlTags(blog.description ?? "").trim()).setMaxLines(lines: 3).size(context.font.small).color(context.color.textColorDark.withOpacity(0.5)),
              ),
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(12.0, 4, 12, 6),
                child: Text(blog.createdAt == null ? "" : blog.createdAt.toString().formatDate()).size(context.font.smaller).color(context.color.textColorDark.withOpacity(0.5)),
              ),
              const SizedBox(
                height: 5,
              ),
          ...
          return Padding(
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: context.color.secondaryColor, border: Border.all(width: 1.5, color: context.color.borderColor)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomShimmer(
