...
class _SubscriptionPackageListScreenState extends State<SubscriptionPackageListScreen> {
            ...
            if (state is FetchAdsListingSubscriptionPackagesSuccess) {
              ...
              return PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return SubscriptionPlansItem(itemIndex: currentIndex, index: index, model: state.subscriptionPackages[index]);
                  },
...
/*  Row Indicator(FetchAdsListingSubscriptionPackagesSuccess state, BuildContext context) {
  ...
  Widget PlanFacilityRow({required String icon, required String facilityTitle, required String count}) {
    return Row(
      children: [
        SvgPicture.asset(
          icon,
        ...
        Text("$facilityTitle $count").size(context.font.large).color(context.color.textColorDark.withOpacity(0.8))
      ],
    );
  }
}
