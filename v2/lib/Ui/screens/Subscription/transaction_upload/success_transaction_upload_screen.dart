...
class SuccessTransactionUploadScreen extends StatefulWidget {
  const SuccessTransactionUploadScreen({
    super.key,
  });
  ...
  static Route route(RouteSettings settings) {
    return BlurredRouter(
      builder: (context) {
        return SuccessTransactionUploadScreen();
      },
    );
  }

  @override
  _SuccessTransactionUploadScreenState createState() => _SuccessTransactionUploadScreenState();
}

class _SuccessTransactionUploadScreenState extends State<SuccessTransactionUploadScreen> with SingleTickerProviderStateMixin {
                        ...
                        SlideTransition(
                          ...
                          child: Column(
                            children: [
                              ...
                              Center(
                                child: Text(
                                  "Thank you for making payment, we will verify within 1x2 hours",
