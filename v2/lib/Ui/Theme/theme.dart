...
const Color territoryColor_ = Color(0xFFA30100);
...
extension ColorPrefs on ColorScheme {
  ...
  Color get shimmerBaseColor => brightness == Brightness.light ? const Color.fromARGB(255, 225, 225, 225) : const Color.fromARGB(255, 150, 150, 150);
