...
/*  void listenIAP(BuildContext context) {
  ...
  void purchaseCompleteDialog(
    ...
    if (packageId != null) {
      Constant.navigatorKey.currentContext!.read<InAppPurchaseCubit>().inAppPurchase(packageId: int.parse(packageId!), method: "apple", purchaseToken: purchase.purchaseID!);
    }
    UiUtils.showBlurredDialoge(
      ...
      dialoge: BlurredDialogBox(
        ...
        acceptTextColor: Constant.navigatorKey.currentContext!.color.buttonColor,
