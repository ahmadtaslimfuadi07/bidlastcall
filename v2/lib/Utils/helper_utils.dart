...
/*  static String decryptString(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                String text = "Exciting find! 🏡 Check out this amazing item I came across.  Let me know what you think! ⭐\n Here are the details:\n$deepLink.";
  ...
  static showSnackBarMessage(BuildContext? context, String message, {int messageDuration = 3, MessageType? type, bool? isFloating, VoidCallback? onClose}) async {
  ...
  static Future<String> getJsonResponse(BuildContext context, {bool isfromfile = false, StreamedResponse? streamedResponse, Response? response}) async {
    int code;
    if (isfromfile) {
  ...
  static goToNextPage(var nextpage, BuildContext bcontext, bool isreplace, {Map? args}) {
    if (isreplace) {
