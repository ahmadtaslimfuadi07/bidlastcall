...
class Api {
  static Map<String, dynamic> headers() {
    if (!HiveUtils.isUserAuthenticated()) {
      ...
      // print("get jwt****$jwtToken -- ${HiveUtils.getLanguage()['code']}");

      // return {"Authorization": "Bearer $jwtToken", "Accept": "application/json", "Content-Language": HiveUtils.getLanguage()['code'] ?? ""};
      return {"Authorization": "Bearer $jwtToken", "Accept": "application/json", "Content-Language": 'en'};
    }
  }
...
//
  ...
  static String getPaymentDetailsApi = "sell-history";
  static String deleteAdvertisementApi = "delete-advertisement";
  static String deleteChatMessageApi = "delete-chat-message";

  //Bid Coins
  static String getBidCoinsListApi = "bidcoin-balances";
  static String getBidCoinsPackageApi = "get-bidcoin-package";
  static String postPurchaseBidcoinApi = "purchase-bidcoin";
  ...
  static String termsAndConditionsSeller = "terms_conditions_seller";
  ...
  static Future<Map<String, dynamic>> post({
    ...
    try {
      ...
      print("formData2 ${headers()} -- ");

      print("url ${((useBaseUrl ?? true) ? Constant.baseUrl : "") + url} ");
...
*/ /*      if (parameter is Map<String, dynamic>) {
  ...
  static void userExpired() {
    HelperUtils.showSnackBarMessage(Constant.navigatorKey.currentContext!, "userIsDeactivated".translate(Constant.navigatorKey.currentContext!), messageDuration: 3);
  ...
  static Future<Map<String, dynamic>> delete({required String url, Map<String, dynamic>? queryParameters, bool? useBaseUrl}) async {
    try {
      //
      final Dio dio = Dio();
      dio.interceptors.add(NetworkRequestInterseptor());
      ...
      final response = await dio.delete(((useBaseUrl ?? true) ? Constant.baseUrl : "") + url,
