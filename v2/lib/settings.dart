...
class AppSettings {
  /// Basic Settings
  static const String applicationName = 'Bidlastcall';
  static const String andoidPackageName = 'com.lastcall.apps';
  static const String iOSAppId = '12345678';
  static const String playstoreURLAndroid = "https://play.google.com/store/apps/details?id=$andoidPackageName";
...
// DON'T FORGET TO GET HTTPS:// OR HTTP:// BEFORE YOUR ADMIN PANEL URL OR HOST URL
  ...
  static final String baseUrl = "${HelperUtils.checkHost(hostUrl)}api/"; //don't change this
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  static const String deepLinkPrefix = "https://eclassify.page.link"; //demo.page.link
 ...
 Country number choose option in login screen. if your App is for only one country this might be helpful*/
  ...
  static const String progressLottieFileWhite = "loading_white.json"; //When there is dark background and you want to show progress so it will be used
