...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GTMSessionFetcher.default-Core/GTMSessionFetcher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleSignIn-framework/GoogleSignIn.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/device_region/device_region.framework"
